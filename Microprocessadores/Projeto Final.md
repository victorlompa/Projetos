...
Genius ou simon (como é conhecido em inglês) é um jogo que consiste em memorizar a sequência apresentada por um brinquedo em forma de disco com botões coloridos que acendem e tocam soms

O jogo foi desenvolvido para que tivesse a dificuldade configurável por dois parâmetros: o número de repetições para se vencer o jogo e a velocidade com que as repetições são apresentadas, o tempo de duração da luz e do som. Ao entrada dos dados 
